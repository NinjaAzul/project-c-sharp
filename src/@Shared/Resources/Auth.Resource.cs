...
public static class AuthResource
{
    ...
    {
        public MessagesResource() : base("Project_C_Sharp.Shared.I18n.Modules.Auth.Messages") { }
    }

    private class ErrorsResource : BaseResource
    {
        public ErrorsResource() : base("Project_C_Sharp.Shared.I18n.Modules.Auth.Errors") { }
    }
